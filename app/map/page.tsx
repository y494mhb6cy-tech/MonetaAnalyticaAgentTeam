...
const validModules = orgMap.modules.filter((module): module is Module => isValidModule(module));
...
const validLinks = orgMap.links.filter((link): link is Link => isValidLink(link));
